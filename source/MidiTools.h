...
inline float nrpnValueToFloat (int value)
{
    return static_cast<float> (value) / 127.0f / 127.0f;
}

inline int floatToNrpnValue (float value)
{
    return static_cast<int> (value * 127 * 127);
}
